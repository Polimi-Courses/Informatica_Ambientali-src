...
void test_city_list_inserts() {
  ...
  printf("Inserting %s\n", c1->name);
  insert_ordered(l, a, compare_city, false, NULL);
  printf("Inserted %s\n", c1->name);
  print_list(stdout, l, to_string_city);

  printf("Inserting %s\n", c2->name);
  insert_ordered(l, b, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);

  printf("Inserting %s\n", c3->name);
  insert_ordered(l, c, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);

  // Testing also build_and_insert_ordered
  printf("Inserting %s\n", c4->name);
  build_and_insert_ordered(l, c4, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);

  printf("Inserting %s\n", c5->name);
  build_and_insert_ordered(l, c5, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);

  printf("Inserting %s\n", c6->name);
  build_and_insert_ordered(l, c6, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);

  printf("Inserting %s\n", c7->name);
  build_and_insert_ordered(l, c7, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);
}

void test_city_list_searchs() {
  ...
  List_t *l = (List_t *)malloc(sizeof(List_t));
  build_and_insert_ordered(l, c1, compare_city, false, NULL);
  build_and_insert_ordered(l, c6, compare_city, false, NULL);
  build_and_insert_ordered(l, c7, compare_city, false, NULL);
...
void test_city_list_binary_searchs() {
  ...
  List_t *l = (List_t *)malloc(sizeof(List_t));
  build_and_insert_ordered(l, c1, compare_city, false, NULL);
  build_and_insert_ordered(l, c2, compare_city, false, NULL);
  build_and_insert_ordered(l, c3, compare_city, false, NULL);
  build_and_insert_ordered(l, c4, compare_city, false, NULL);
  build_and_insert_ordered(l, c6, compare_city, false, NULL);
  build_and_insert_ordered(l, c7, compare_city, false, NULL);
  print_list(stdout, l, to_string_city);
...
// TODO
// If we have same id for different
// We want to append data of node_b to data of node_a
void merge_data(Node_t *node_a, Node_t *node_b) {
  Data_t **data_a = (Data_t **)node_a->info;
  Data_t **data_b = (Data_t **)node_a->info;
}
...
int main(int argc, char *argv[]) {
  ...
  printf("*********\n");
  test_city_list_searchs();
  printf("*********\n");
  test_city_list_binary_searchs();
  printf("*********\n");
